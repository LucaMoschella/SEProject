...
%%%%%%%%%%%%		 TIPS 		%%%%%%%%%%%%%%%%%
%-1) Il libro "L'arte di scrivere in LaTeX" è ottimo (vedi fonti) :D
...
%10) Per inserire una note a pié di pagina: \footcite{bibid}	- Meglio fare una macro e chiamare quella
%11) Per inserire una note a margine:	\marginpar{}     		- Meglio fare una macro e chiamare quella
...
%17)Per i comandi di base LaTex: strumenti -> LaTeX
