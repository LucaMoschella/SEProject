...
\begin{document} %inizio stesura documento
    ...
    \tableofcontents
%
    \include{documents/RichiestaSistema}
    \include{documents/DocumentoVisione}
    \include{documents/StudioFattibilita}
    \include{documents/Contratto}
    \include{documents/Pianificazionedelprogetto}
	\include{documents/SpecificaSistema}
    \include{documents/SpecificaRequisiti}
    \include{documents/UseCase}
    \include{documents/ValutazioneDeiRischi}
    \include{documents/StimaDeiCosti}   
    \include{documents/AnalisiDelSistema}
    \include{documents/DesignDelSistema}
    \include{documents/DocumentoTest}
