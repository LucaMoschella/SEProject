...
\begin{itemize}
	\item Le \ruolo{Utenze}:
		...
		\end{description}
	\item Le \ruolo{Figure di gestione del portale}:
		\begin{description}
...
\begin{itemize}
	\item l’implementazione della \futuro{wishlist} per ricordarsi dei prodotti che si vorrebbero provare.

	\item l’aggiunta del \futuro{produttore delegato}, una figura necessaria per aiutare le piccole realtà dolciarie che si occuperà di gestire le vetrine al loro posto.

	\item Aggiunta dei commenti alle \futuro{notizie}.
\end{itemize}
