...
Il seguente contratto avrà validità previa approvazione delle specifiche del sistema e della \docref{cha:stima_costi}.

\section{Caratteristiche del sistema} 
\label{sec:caratteristiche_del_sistema}
Il sistema che si intende realizzare è quello descritto ad alto livello nel documento di \docref{cha:documento_di_visione}, esso verrà descritto nel dettaglio nei documenti di specifica. 
...
\section{Costi} 
\label{sec:costi}
L'analisi dei costi è disponibile nel documento di \docref{cha:stima_costi}.
