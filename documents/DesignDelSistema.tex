...
{\aprlong{wp} gestisce la creazione delle pagine profilo, \acrlong{pbp} permette agli amministratori di creare profili personalizzati in base al tipo di account}
