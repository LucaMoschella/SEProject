...
{\nameref{cms:wp}, \nameref{plugin:pbp}, \nameref{plugin:bp}, \nameref{plugin:bpf}, \nameref{plugin:nf}}
{\nameref{cms:wp} permette la modifica del profilo, \nameref{plugin:pbp} permette agli amministratori di creare profili personalizzati in base al tipo di account. In particolare i profili dei produttori avranno una vetrina associata, \nameref{plugin:bp} e \nameref{plugin:bpf} permettono di gestire le funzionalità di follower/followed, \nameref{plugin:bp} e \nameref{plugin:nf} permettono di la gestione delle richieste prodotto}

\vspaceTab

\classeTab{classe:Vetrina}
{\nameref{plugin:wc}, \nameref{plugin:wcv}}
{\nameref{plugin:wc} gestisce la vetrina, mentre il plugin \nameref{plugin:wcv} permette di avere negozi multipli, creando una vetrina alla creazione di ogni account produttore}

\vspaceTab

\classeTab{classe:AccessoIscritto}
{\nameref{cms:wp}, \nameref{plugin:atfa}}
{\nameref{cms:wp} gestisce il controllo degli accessi degli iscritti al sistema, \nameref{plugin:atfa} gestisce l'accesso a due passaggi per gli account amministrativi}

\vspaceTab

\classeTab{classe:AccessoOspite}
{\nameref{cms:wp}}
{\nameref{cms:wp} gestisce il controllo degli accessi dei visitatori al sistema}
