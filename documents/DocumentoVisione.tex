...
\begin{itemize}
	...
	\item \stato{Autenticate}:
					\begin{descriptionInd}
					    \item[Produttori] \emph{Industriali} o  \emph{Artigianali}, useranno il portale per pubblicizzare i propri prodotti; per commentare le recensioni dei propri prodotti.
