...
\begin{itemize} 
	\item \reqLabel{req:prova}{\ereq{RF}{100000}{A}} - provaprova
	...
	\item \reqLabel{req:rimozioneaccount}{\ereq{RF}{000001}{B}} - Rimozione account altrui 
	\countReset
...
iscrizione:  \reqDefRef{req:iscrizione} \\
iscportal:  \reqDefRef{req:iscrizionePortale} \\
iscSocial:  \reqDefRef{req:iscrizioneSocial} \\
iscSocialVer:  \reqDefRef{req:iscrizioneSocialVer} \\
iscsocialnot:  \reqDefRef{req:iscrizioneSocialNotVer} \\
iscapp  \reqDefRef{req:iscrizioneApprovazione}\\
log  \reqDefRef{req:login}\\
appr  \reqDefRef{req:approvazioneIscrizione}\\
rem  \reqDefRef{req:rimozioneaccount}\\

Ma possiamo riusare i nomi, linkandoli all'elenco, senza creare problemi al link elenco -> def!\\
iscrizione:  \reqRef{req:iscrizione} \\
iscportal:  \reqRef{req:iscrizionePortale} \\
iscSocial:  \reqRef{req:iscrizioneSocial} \\
iscSocialVer:  \reqRef{req:iscrizioneSocialVer} \\
iscsocialnot:  \reqRef{req:iscrizioneSocialNotVer} \\
iscapp  \reqRef{req:iscrizioneApprovazione}\\
log  \reqRef{req:login}\\
appr  \reqRef{req:approvazioneIscrizione}\\
rem  \reqRef{req:rimozioneaccount}\\

Provaidsvuiosbvcosneui: \\
prova: \reqDefRef{req:prova}