...
\reqTabRF{req:personalizzaVetrinaInsProd}{Deve essere possibile per il produttore inserire una scheda prodotto nella propria vetrina}{\prioritaH}{\statoUn}

\vspaceTab

\reqTabRF{req:personalizzaVetrinaModProd}{Deve essere possibile per il produttore modificare una scheda prodotto già inserito nella propria vetrina}{\prioritaH}{\statoUn}
...
\reqTabRF{req:prodottiSimili}{Il portale deve permettere di ricevere suggerimenti riguardo quali altre schede prodotto sono simili a quello che si sta visualizzando}{\prioritaL}{\statoUn}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% H - GESTIONE ACCOUNT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\reqTabRF{req:modificaProfilo}{Il portale deve permette la modifica del proprio profilo}{\prioritaM}{\statoUn}
...
\reqTabRF{req:aggiungiPrivilegioFigura}{Il portale deve permettere agli amministratori di aggiungere un privilegio ad un account presente nel sistema, che non possiede già tale privilegio. Fornendogli in tal modo funzionalità aggiuntive}{\prioritaL}{\statoUn}

\vspaceTab

\reqTabRF{req:rimuoviPrivilegioFigura}{Il portale deve permettere agli amministratori di rimuovere un privilegio da un account presente nel sistema. Rimuovendogli in tal modo funzionalità aggiuntive, se non disponibili grazie ad altri privilegi già posseduti}{\prioritaL}{\statoUn}

\vspaceTab

\reqTabRF{req:creaAccount}{Il portale deve permettere agli amministratori di creare un account nel sistema, assegnandogli i privilegi che desidera}{\prioritaL}{\statoUn}
...
\reqTabRF{req:ricercaProdotto}{Deve essere possibili cercare schede prodotto in base a diversi criteri}{\prioritaH}{\statoUn}
...
\reqTabRF{req:richiestaInsProdotto}{Deve essere possibile segnalare ad un produttore la mancanza di una sua scheda prodotto tra quelli presenti nel sistema. La segnalazione conterrà una scheda prodotto parzialmente compilata dall'utente per favorirne l'aggiunta da parte del produttore}{\prioritaL}{\statoUn}

\vspaceTab

\reqTabRF{req:mostraRichiesteInsProdotto}{Il produttore potrà visualizzare le richieste di inserimento delle schede prodotto indirizzate a lui, con la possibilità di inserire direttamente la scheda prodotto consigliata, modificarla o rifiutare la richiesta.}{\prioritaL}{\statoUn}
...
\reqTabRF{req:mostraProdotto}{Il portale deve permettere di visualizzare una data scheda prodotto}{\prioritaH}{\statoUn}
