...
%USAGE: {keyrequisito}{\ereq{tipo}{contesto}{categoria}}{titolo} - doublelink automatico con \refDef{keyrequisito}
\begin{itemize}
	\item  \reqItem{req:sicurezzaHttps}{\ereq{RNF}{1111111}{A}}{Protollo \texttt{HTTPS}}

	\item  \reqItem{req:sicurezzaDati}{\ereq{RNF}{1111111}{A}}{Protezione dei dati}
	\countReset

	\item  \reqItem{req:usabilitaInterfaccia}{\ereq{RNF}{1111111}{B}}{Interfaccia intuitiva del portale}
	\item  \reqItem{req:usabilitaRicerca}{\ereq{RNF}{1111111}{B}}{Semplicità ricerca contenuti}
	\countReset

	\item  \reqItem{req:portabilitaBrowser}{\ereq{RNF}{1111111}{C}}{Sito web portabile fra browser}
	\item  \reqItem{req:portabilitaMobile}{\ereq{RNF}{1111111}{C}}{Sito web responsive}
	\countReset

	%\item  \reqItem{req:implementazioneDDF}{\ereq{RNF}{1111111}{D}}{ }
	%\countReset

	%\item  \reqItem{req:standards}{\ereq{RNF}{0000000}{E}}{Rispetto degli standard}
	%\countReset
\end{itemize}
