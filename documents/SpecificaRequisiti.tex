...
\begin{itemize}
	...
	\item Il \campiIdReq{contesto} serve ad identificare a quali figure è rivolta una data funzionalità, è un numero composto da 7 cifre ognuna delle quali può assumere valore 0 oppure 1. La posizione della cifra si riferisce ad una specifica figura, se la cifra i-esima vale 1 significa che l'i-esima figura è presente nel contesto del requisito, altrimenti no.
	Di seguito elenchiamo ogni posizione a quale figura riferisce: 
	\begin{descriptionInd}
		\item[\setTextToLabel{V}{req:visitatore}] Visitatore.
		\item[\setTextToLabel{U}{req:utente}] Utente. 
		\item[\setTextToLabel{P}{req:produttore}] Produttore. 
		\item[\setTextToLabel{R}{req:redattore}] Redattore. 
		\item[\setTextToLabel{A}{req:assistente}] Assistente. 
		\item[\setTextToLabel{M}{req:moderatore}] Moderatore. 
		\item[\setTextToLabel{S}{req:amministratore}] Amministratore. 
	\end{descriptionInd}		
