...
\begin{itemize} 
	...
	\item \reqItem{req:aggiungiAccountAFigura}{\ereq{RF}{\noF\noF\noF\noF\noF\noF\amministratore}}{Aggiungi account a figura}
	\item \reqItem{req:rimuoviAccountDaFigura}{\ereq{RF}{\noF\noF\noF\noF\noF\noF\amministratore}}{Rimuovi account da figura}
	...
	\item \reqItem{req:ticketLettura}{\ereq{RF}{\noF\noF\noF\noF\assistente\noF\amministratore}}{Lettura di un ticket}
...
\reqTabRF{req:aggiungiAccountAFigura}{Il portale deve permettere agli amministratori di aggiungere un account presente nel sistema ad una figura. In questo modo l'account avrà accesso anche alle funzionalità associate alla figura in questione.}{\prioritaL}{\statoUn}

\tabreqvspace

\reqTabRF{req:rimuoviAccountDaFigura}{Il portale deve permettere agli amministratori di rimuovere un account presente nel sistema da una figura. In questo modo l'account non avrà più accesso alle funzionalità associate alla figura in questione, se tali funzionalità non sono presenti in altre figure associate all'account.}{\prioritaL}{\statoUn}
