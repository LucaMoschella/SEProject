...
\begin{itemize}
	...
	\item Il \campiIdReq{contesto} serve ad identificare a quali figure è rivolta una data funzionalità, è un numero composto da 7 cifre ognuna delle quali può assumere valore 0 oppure 1. La posizione della cifra si riferisce ad una specifica figura, se la cifra i-esima vale 1 significa che l'i-esima figura è presente nel contesto del requisitio, altrimenti no.
	Di seguito elenchiamo ogni posizione a quale figura riferisce: 
	\begin{descriptionInd}
		\item[V] Visitatore.\setTextToLabel{V}{req:visitatore}
		\item[U] Utente. \setTextToLabel{U}{req:utente}
		\item[P] Produttore. \setTextToLabel{P}{req:produttore}
		\item[R] Redattore. \setTextToLabel{R}{req:redattore}
		\item[A] Assistente. \setTextToLabel{A}{req:assistente}
		\item[M] Moderatore. \setTextToLabel{M}{req:moderatore}
		\item[S] Amministratore. \setTextToLabel{S}{req:amministratore}
	\end{descriptionInd}		
...
\begin{itemize} 
	...
	\item \reqItem{req:personalizzaVetrinaInsDesc}{\esubreq{RF}{\noF\noF\produttore\noF\noF\noF\noF}}{Inserimento descrizione}
	\item \reqItem{req:personalizzaVetrinaInsImg}{\esubreq{RF}{\noF\noF\produttore\noF\noF\noF\noF}}{Inserimento immagine}
	\item \reqItem{req:personalizzaVetrinaInsProd}{\esubreq{RF}{\noF\noF\produttore\noF\noF\noF\noF}}{Inserimento prodotto}
	\item \reqItem{req:personalizzaVetrinaModProd}{\esubreq{RF}{\noF\noF\produttore\noF\noF\noF\noF}}{Modifica prodotto}
	...
	\item \reqItem{req:ticketComunicazione}{\ereq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Comunicazione tramite tickets}
	\item \reqItem{req:ticketInvio}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Invio di un ticket}
	\item \reqItem{req:ticketRisposta}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Risposta ad un ticket}
	\item \reqItem{req:ticketChiudi}{\esubreq{RF}{\noF\noF\noF\noF\assistente\noF\amministratore}}{Chiusura di un ticket}
	...
	\item \reqItem{req:ricercaProdotto}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Ricerca prodotto}
	\item \reqItem{req:ricercaProfilo}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Ricerca profilo}
	\item \reqItem{req:ricercaNotizia}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Ricerca notizia}
	...
	\item \reqItem{req:visualizzazioneStatistichePubVetrina}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione statische pubbliche vetrina}
	\item \reqItem{req:visualizzazioneProdottiVetrina}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione prodotti esposti in vetrina}
	...
	\item \reqItem{req:visualizzazioneInfoProdotto}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione informazioni del prodotto}
	\item \reqItem{req:visualizzazioneRecProdotto}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione recensioni associate al prodotto}
	\item \reqItem{req:visualizzazioneStatProdotto}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione statistiche del prodotto}
	...
	\item \reqItem{req:visualizzazioneInfoProfilo}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione informazioni di un profilo pubblico}
	\item \reqItem{req:visualizzazioneStatProfilo}{\esubreq{RF}{\visitatore\utente\produttore\redattore\assistente\moderatore\amministratore}}{Visualizzazione statistiche di un profilo pubblico}
