...
\begin{itemize}
	\item \campo{Nome prodotto. }
	\item \campo{Almeno una foto dell’articolo.}
	\item \campo{Descrizione di presentazione.}
	\item \campo{Marca.}
	\item \campo{Categoria.}
	\item \campo{Particolarità.}
	\item \campo{Consistenza.}
	\item \campo{Ingredienti.}
	\item \campo{Altri campi} (a seconda dei quali ha compilato il \ruolo{produttore}).
\end{itemize}
