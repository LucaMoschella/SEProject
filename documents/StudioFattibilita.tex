...
In questo documento analizzeremo la fattiblità del sistema proposto nel documento di \docref{cha:documento_di_visione}, analizzandone i principali aspetti.

\section{Obiettivo} 
\label{sec:obiettivo}
Obiettivo di questo progetto è la definizione e realizzazione di un sito web, che permetta ad ogni produttore di avere una propria vetrina contente i proprio prodotti. Il sistema permetterà inoltre la consultazione di informazioni provenienti dal mondo dolciario e fornirà alle figure pubbliche autenticate metodi di interazione.
...
Il portale che si intende realizzare offre funzionalità abbastanza comuni e già messe a dispozione da molti sofware, intendiamo quindi utilizzare un \gls{cms} commerciale, con eventuali estensioni e plugin, che fornisca le funzionalità richieste.
...
\section{Vantaggi} 
\label{sec:vantaggi}
L'uso di un \gls{cms} permetterà di abbattere i costi di sviluppo e implementazione in quanto non sarà necessario re--implementare tutte le funzionalità, poiché già disponibili nel \gls{cms}.
...
Grazie alla soluzione proposta, Chococlub potrà disporre di un portale più fruibile rispetto a quello attuale, con contenuti sempre aggiornati in quanto delegato ai produttori associati ed iscritti al portale. 
...
Il sistema è vantaggioso quindi sia per i produttori, che potranno pubblicizzare i propri prodotti, sia per gli utenti, che potranno interagire direttamente con i produttori, scoprire nuovi prodotti e interagire con altri utenti e sia per Chococlub che, oltre al beneficio di un portale unificante, potrà valutare diversi modi per introdurre nuove fonti di guadagno.
