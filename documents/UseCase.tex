...
\begin{itemize}
	...
	\begin{enumerateIndLabel}{\textsf{\Alph*}}{\Alph*}
		...
		\item Gestioni suggerimenti. \label{pkg:suggerimenti}
		...
		\item Interazione fra figure. \label{pkg:interazione}
		...
		\item Visualizzazione contenuti. \label{pkg:visualizzazione}
