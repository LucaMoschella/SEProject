...
{\begin{enumCU}
		\item Il caso d'uso ha inizio quando un Produttore visualizza la sua vetrina, \inc{cu:visualizzazioneVetrina}
...
{\begin{enumCU}
		\item Il caso d'uso ha inizio quando un Produttore visualizza un prodotto, \inc{cu:visualizzazioneProdotto}
