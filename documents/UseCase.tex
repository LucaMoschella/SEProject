...
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Amministratore effettua la ricerca di un profilo, \inc{cu:ricercaProfilo}
	\item L'Amministratore seleziona un profilo dal risultato della ricerca e richiede al sistema di rimuoverlo \label{curimaccaltr:0}
...
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Amministratore effettua la ricerca di un profilo, \inc{cu:ricercaProfilo}
	\item L'Amministratore seleziona un profilo dal risultato della ricerca\label{cufornpriv:0}
