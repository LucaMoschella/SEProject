...
\begin{itemize} 
	...
	\item \newListItem{cu:iscrizioneSocial}{\formattaCU}{Iscrizione tramite Facebook}
	...
	\item \newListItem{cu:inserisciImgProfilo}{\formattaCU}{Inserimento immagine del profilo}
	\item \newListItem{cu:rimuoviImgProfilo}{\formattaCU}{Rimozione immagine del profilo}
	...
	\item \newListItem{cu:modificaPrivilegiAccount}{\formattaCU}{Modifica tipi di un account}
	\item \newListItem{cu:creaAccount}{\formattaCU}{Crea account}
...
{La persona ha ora un account proprio, creato tramite le API messe a disposizione da Facebook}
{\begin{enumCU}
...
{Nella vetrina del Produttore è stata modificata la scheda del prodotto selezionato}
{\begin{enumCU}
...
{Nel sistema sono stati aggiornati i tipi di quell'account come richiesto}
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Amministratore seleziona un'\gls{anteprima} profilo tra quelle mostrate nel risultato della ricerca e richiede di modificarne i tipi
