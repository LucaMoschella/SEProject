...
\begin{itemize} 
	...
	\item \newListItem{cu:aggiungiAccountAFigura}{\formattaCU}{Aggiungi privilegi ad account}
	\item \newListItem{cu:rimuoviAccountDaFigura}{\formattaCU}{Rimuovi privilegi da account}
	...
	\item \newListItem{cu:visualizzazioneSegnContenutiInap}{\formattaCU}{Visualizzazione segnalazioni contenuti}
	...
	\item \newListItem{cu:visualizzazioneRichiestaInsProdotto}{\formattaCU}{Visualizzazione richiesta prodotto}
...
{\getTitletodesc{att:visitatore}}%
{La persona connessa al sito è inizialmente riconosciuta come Visitatore}%
{La persona connessa al sito è ora riconosciuta Figura Amministrativa}%
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Visitatore richiede di effettuare il login 
	\item Il sistema richiede le credenziali di autenticazione
...
{\begin{enumCU}
		...
		\item Il sistema mostra i prodotti presenti nella vetrina del Produttore e chiede di selezionarne uno
		\item Il Produttore seleziona un prodotto tra quelli mostrati \label{cumodprodelim:0}
...
%***************  Aggiungi privilegi  *****************
\cuTab{cu:aggiungiAccountAFigura}
{\getTitletodesc{att:amministratore}}
...
\end{enumCU}}
%
\cuAlternativo{cu:aggiungiAccountAFigura}
{Flusso alternativo 1}%
{Annulla operazione}%
{La persona è autenticata e ha i privilegi di Amministratore. L'account da modificare è presente nel sistema e non ha già i privilegi della figura scelta}%
{\postNulle}%
...
%***************  Rimuovi privilegi  *****************
\cuTab{cu:rimuoviAccountDaFigura}
{\getTitletodesc{att:amministratore}}
...
\end{enumCU}}
%
\cuAlternativo{cu:rimuoviAccountDaFigura}
{Flusso alternativo 1}%
{Annulla operazione}%
{La persona è autenticata e ha i privilegi di Amministratore. L'account da modificare è presente nel sistema e ha già i privilegi della figura scelta}%
{\postNulle}%
...
\cuTab{cu:visualizzazioneSegnContenutiInap}
...
\end{enumCU}}
%
\cuAlternativo{cu:visualizzazioneSegnContenutiInap}
{Flusso alternativo 1}%
...
\cuTab{cu:visualizzazioneRichiestaInsProdotto}
{\getTitletodesc{att:produttore}}
...
{\begin{enumCU}
	...
	\end{enumCU}}
%
\cuAlternativo{cu:visualizzazioneRichiestaInsProdotto}
{Flusso alternativo 1}%
{Elimina richiesta}%
{La persona è autenticata come Produttore. Nel sistema è presente una richiesta di inserimento prodotto a lui indirizzata}
...
\cuTab{cu:visualizzazioneVetrina}{\getTitletodesc{att:visitatore}, \getTitletodesc{att:utente}, \getTitletodesc{att:produttore}}{La vetrina è presente nel sistema}
...
\cuTab{cu:visualizzazioneProdotto}{\getTitletodesc{att:visitatore}, \getTitletodesc{att:utente}, \getTitletodesc{att:produttore}}{Il prodotto è presente nel sistema}
...
\cuTab{cu:visualizzazioneNotizia}{\getTitletodesc{att:visitatore}, \getTitletodesc{att:utente}, \getTitletodesc{att:produttore}}
