...
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Utente visualizza un prodotto che non ha già recensito, \inc{cu:mostraProdotto}
...
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando la persona visualizza le recensioni di un prodotto, \inc{cu:mostraRecProdotto}
	\item La persona richiede di effettuare un commento ad una recensione tra quelle che sta visualizzando
...
{\begin{enumCU}
	...
	\item Il sistema mostra la segnalazione \ref{delsegn:4}
\end{enumCU}}
%
...
{\begin{enumCU}
	\item Il caso d'uso ha inizio quando un Moderatore visualizza una segnalazione, \inc{mostraSegnCotenutiInap}\label{rim}
