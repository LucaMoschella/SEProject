...
{
    name={Produttore},
    description={è una figura pubblica autenticata nel portale che rappresenta colui che produce prodotti dolciari a base di cioccolata}
}
...
{
    name={Valutazione},
    description={di un prodotto è un voto in una scala limitata per esprimere la bontà di un dato prodotto}
}
...
{
    name={Notizia},
    description={indica un articolo o una novità proveniente al mondo dolciario}
}
%Acronimi
