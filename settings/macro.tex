...
\newcommand{\esubreq}[2]{%
    ...
    \def\@currentlabel{\subreq{#1}{#2}{\getCat}{\arabic{req}}{\alph{sottoreq}}}%
	\subreq{#1}{#2}{\getCat}{\arabic{req}}{\alph{sottoreq}}%
}
\makeatother
...
\newcommand{\esubsubreq}[2]{%
    ...
    \def\@currentlabel{\subsubreq{#1}{#2}{\getCat}{\arabic{req}}{\alph{sottoreq}}{\alph{sottosottoreq}}}%
	\subsubreq{#1}{#2}{\getCat}{\arabic{req}}{\alph{sottoreq}}{\alph{sottosottoreq}}%
}
\makeatother
