...
\newcommand\reqLabel[2]{\hyperref[descrizione:#1]{#2\phantomsection\label{elenco:#1}}}
\newcommand\reqDefRef[1]{\ref{elenco:#1}\phantomsection\label{descrizione:#1}}
\newcommand\reqRef[1]{\ref{elenco:#1}}
