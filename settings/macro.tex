...
\newcommand{\ereq}[2]{%
    \stepcounter{req}%
    \def\@currentlabel{\req{#1}{#2}{\getCat}{\arabic{req}}}%
    \req{#1}{#2}{\getCat}{\arabic{req}}%
}
\makeatother
...
\newcommand{\esubreq}[2]{%
    ...
    \def\@currentlabel{\subreq{#1}{#2}{\getCat}{\arabic{req}}{\arabic{sottoreq}}}%
	\subreq{#1}{#2}{\getCat}{\arabic{req}}{\arabic{sottoreq}}%
}
\makeatother
...
\newcommand{\esubsubreq}[2]{%
    ...
    \def\@currentlabel{\subsubreq{#1}{#2}{\getCat}{\arabic{req}}{\arabic{sottoreq}}{\arabic{sottosottoreq}}}%
	\subsubreq{#1}{#2}{\getCat}{\arabic{req}}{\arabic{sottoreq}}{\arabic{sottosottoreq}}%
}
\makeatother
	...
	\begin{center}
		\begin{minipage}[t]{\linewidth}
			...
			\begin{tabularx}{\tabwidthreq}{ l  X }
				\toprule
				\multicolumn{2}{c}{\tabtitlereq{\reqGetTitle{#1}}}  \\
...
\newcommand{\visitatore}{\ref*{req:visitatore}} 
\newcommand{\utente}{\ref*{req:utente}} 
\newcommand{\produttore}{\ref*{req:produttore}} 
\newcommand{\redattore}{\ref*{req:redattore}} 
\newcommand{\assistente}{\ref*{req:assistente}} 
\newcommand{\moderatore}{\ref*{req:moderatore}} 
\newcommand{\amministratore}{\ref*{req:amministratore}} 
