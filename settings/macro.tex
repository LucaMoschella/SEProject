...
\newcommand\newListItem[3]{\hyperref[desc:#1]{#2\phantomsection\label{id:#1}}\sepIDTitle\titleLabel{#3}\label{title:#1}}
...
\newcommand{\ereq}[2]{%
    \stepcounter{req}%
    \def\@currentlabel{\req{#1}{#2}{\getCatR}{\arabic{req}}}%
...
\newcommand{\esubreq}[2]{%
    ...
    \def\@currentlabel{\subreq{#1}{#2}{\getCatR}{\arabic{req}}{\arabic{sottoreq}}}%
...
\newcommand{\esubsubreq}[2]{%
    ...
    \def\@currentlabel{\subsubreq{#1}{#2}{\getCatR}{\arabic{req}}{\arabic{sottoreq}}{\arabic{sottosottoreq}}}%
...
\newcommand{\formattaAtt}{%
    \stepcounter{counterAtt}%
    \def\@currentlabel{\att{ATT}{\arabic{counterAtt}}}%
...
\newcommand{\formattaCU}{%
    \stepcounter{counterCU}%
    \def\@currentlabel{\cu{CU}{\getCatCU}{\arabic{counterCU}}}%
...
\newcommand{\cuAlternativo}[6]{%
	\begin{center}
		\begin{minipage}[t]{\linewidth}
			...
			\begin{tabularx}{\textwidth}{ l  X }
				\toprule
				\multicolumn{2}{c}{\getTitle{#1} - \tabtitleflussosec{#2} }  \\
				\cmidrule(l{\cmidrulekern}r{\cmidrulekern}){1-2}
				...
				\addlinespace[0.5em]
				\tabheadreq{Flusso alternativo} &  #6 \\
				\addlinespace[0.5em]
