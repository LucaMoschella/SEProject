...
%usage: \reqDef{reqkey}
\newcommand\reqDef[1]{\phantomsection\ref{id:#1}\label{desc:#1}}
...
\newcommand{\reqTabRF}[4]{%
\begin{center}
	\begin{tabularx}{\tabwidthreq}{ l  X } 
		\toprule
			\multicolumn{2}{c}{\tabtitlereq{\reqDef{#1}\sepIDTitle\reqGetTitle{#1}}}  \\
		\cmidrule(l{\cmidrulekern}r{\cmidrulekern}){1-2}
			...
			\addlinespace[1em]
			\tabheadreq{Tipo} &  Requisito funzionale \\
			\addlinespace[1em]
			\tabheadreq{Priorità} &  #3 \\
			\addlinespace[1em]
			\tabheadreq{Stato} &  #4 \\
		\bottomrule
	\end{tabularx}
...
\begin{center}
	\begin{tabularx}{\tabwidthreq}{ l  X } 
		...
		\cmidrule(l{\cmidrulekern}r{\cmidrulekern}){1-2}
			...
			\tabheadreq{Descrizione} &  #2 \\		
			\addlinespace[1em]
			\tabheadreq{Tipo} &  Requisito non funzionale \\
			\addlinespace[1em]
			\tabheadreq{Priorità} &  #3 \\
			\addlinespace[1em]
			\tabheadreq{Stato} &  #4 \\
